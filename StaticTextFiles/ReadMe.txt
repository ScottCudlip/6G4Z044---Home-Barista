...
Home Barista is an at-home drink ordering app, similar to how you can order drinks in the 'Starbucks' app.

1.  There are 2 hardcoded user profiles, "Customer" and "Admin" which have different options/experiences within the app. The logins for these are below.

    Customer Profile...         |       Admin Profile...
    - Username = customer       |       - Username = admin
